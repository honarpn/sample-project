...
class change_password_view extends View {
    ...
    public function __construct($params) {
        ...
        $this->setHeader();
        $this->setBody();
        $cache_file = fopen(__SITE_PATH . "/src/app/cache/change_password_view.html", "w") or die("Unable to open file!");
        fwrite($cache_file, $this->setHeader() . $this->setBody() . $this->setFooter());
        fclose($cache_file);
        include __SITE_PATH . "/src/app/cache/change_password_view.html";
    }
    ...
    public function setBody() {
        ...
        $body.=$form->change_password_form();
